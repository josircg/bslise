...
class ProjectForm(forms.Form):
    ...
    description_citizen_science_aspects = forms.CharField(
        ...
        help_text=_('Please describe the citizen science aspect(s) of the project and the link of the project toSA'
                    ...
                    '<a href="https://zenodo.org/record/5127534#.YV8J0dpBxPa">ECSA 10 '
...
class InviteProjectForm(forms.Form):
    ...
    email = forms.EmailField(label=_('Cooperator email'), required=False,
                             help_text=_("You can invite a cooperator to this project. "
                                         "Enter his email address here to send the invitation. "
                                         "Cooperators are authorized to change all registration information. "
                                         "Therefore, be careful when assigning this role to someone."))
